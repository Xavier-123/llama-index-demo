...
# cfg["COLLECTION_NAME"] = os.environ.get("COLLECTION_NAME", "pdd-all-20240730")
# cfg["COLLECTION_NAME"] = os.environ.get("COLLECTION_NAME", "pdd-sichuan-jike-new")
cfg["COLLECTION_NAME"] = os.environ.get("COLLECTION_NAME", "pdd-sichuan-jike-md")
# cfg["COLLECTION_NAME"] = os.environ.get("COLLECTION_NAME", "pdd-all-new")
...
cfg["DATA_DIR"] = os.environ.get("DATA_DIR", 'data/Product_Department_Data/算网运营/四川集客相关文档-Markdown格式/')
