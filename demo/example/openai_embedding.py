...
model = SentenceTransformer(
    r'F:\inspur\EMBEDDING_MODEL\m3e-small',
    device="cuda",
...
async def get_embeddings(http_request: Request, request: EmbeddingRequest,
                         credentials: HTTPAuthorizationCredentials = Depends(security)):
    ...
    ).tolist() for text in request.input]
